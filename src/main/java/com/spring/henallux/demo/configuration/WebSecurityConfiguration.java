...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] AUTHORIZED_REQUESTS_ANYBODY = new String[]{"/bienvenue", "/css/**", "/images/**", "/js/**"};
    private static final String[] AUTHORIZED_REQUESTS_ADMIN = new String[]{"/admin"};
    private static final String[] AUTHORIZED_REQUESTS_USER = new String[]{"/authenticated"};
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(AUTHORIZED_REQUESTS_USER).hasRole("USER") // For the request to "/authenticated", the user needs to be authenticated
